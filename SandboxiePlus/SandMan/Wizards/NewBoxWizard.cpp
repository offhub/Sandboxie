    ...
    : QWizardPage(parent)
{
    ...
    for (int i = 0; i <= 9; ++i) {
        ...
        QString toolTipText = tr("This option adds the settings from %1 to the box configuration and may also remove default settings if specified.").arg(templateName);
    ...
    connect(m_pSharedTemplate, QOverload<int>::of(&QComboBox::currentIndexChanged),
