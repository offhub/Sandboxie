...
if %1 == x64 if exist %~dp0..\..\Qt\%qt_version%\msvc%msvc_version%_64\bin\lrelease.exe set PATH=%PATH%;%~dp0..\..\Qt\%qt_version%\msvc%msvc_version%_64\bin\
if %1 == Win32 if exist %~dp0..\..\Qt\%qt_version%\msvc%msvc_version%\bin\lrelease.exe set PATH=%PATH%;%~dp0..\..\Qt\%qt_version%\msvc%msvc_version%\bin\
