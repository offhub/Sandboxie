...
IF %1 == x86 (
  ...
  set qtPath=%~dp0..\..\Qt\%qt_version%\msvc%msvc_version%
...
REM  set qtPath=%~dp0..\..\Qt\%qt6_version%\msvc%msvc_version%_64
  set qtPath=%~dp0..\..\Qt\%qt_version%\msvc%msvc_version%_64
...
IF %1 == ARM64 (
  ...
  set qtPath=%~dp0..\..\Qt\%qt6_version%\msvc%msvc_version%_arm64
  set instPath=%~dp0\SbiePlus_a64
  set "sslMajorVersion=1_1"
)

REM set redistPath=%VCToolsRedistDir%\%1\Microsoft.VC%vctools_version%.CRT
set redistPath=C:\Program Files (x86)\Microsoft Visual Studio\%msvc_version%\Enterprise\VC\Redist\MSVC\%VCToolsVersion%\%1\Microsoft.VC%vctools_version%.CRT
