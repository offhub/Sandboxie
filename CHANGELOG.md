...
- improved SandMan responsiveness during stop/start refreshes by pausing task list refresh during interaction; configurable with `Options/PauseRefreshOnInteraction`
